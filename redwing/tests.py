...
class TestDataTypes(unittest.TestCase):
    ...
    def test_numeric_type_check(self):
        ...
        self.assertTrue(numeric_data_type.test_type('235'))
        self.assertTrue(numeric_data_type.test_type('200'))
        self.assertTrue(numeric_data_type.test_type('9582'))
        self.assertTrue(numeric_data_type.test_type('8295'))
        ...
        self.assertTrue(numeric_data_type.test_type('5235'))
